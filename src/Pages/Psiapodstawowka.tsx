...
const Psiapodstawowka = () => {
  ...
  return (
    <>
      ...
      <List spacing={16} my={16}>
        <List.Item icon={<IconDog size={64} />}>
          <Text>
            ...
            'Zostań' (nawet w rozproszeniach!), 'siad' i 'leżeć' na odległość,
            'czekaj' przy drzwiach czy przed miseczką oraz perfekcyjnego
            przywołania.
          </Text>
        </List.Item>
        <List.Item icon={<IconPaw size={64} />}>
          <Text>
            ...
            Czas na spacery, które będą czystą przyjemnością - bez ciągnięcia,
            zatrzymywania się i psiej „jazdy figurowej”.
          </Text>
        </List.Item>
        <List.Item icon={<IconCirclesRelation size={64} />}>
          <Text>
            ...
            Obcy ludzie, psy, rowery i inne pokusy? Twój pies będzie wiedział,
            jak zachować spokój i skupienie.
          </Text>
        </List.Item>
      ...
      <Title order={2} fw={400} my={16}>Dlaczego w grupie?</Title>
      <Text my={16}>
      ...
      <Title order={2} fw={400} my={16}>Psiapodstawówka - dla kogo?</Title>
      <Grid mx='10%' my={32}>
      <Grid.Col span={4}>
        <Text>
        Dla psów od 6. miesiąca życia, które opanowały podstawy, ale chcą nauczyć się więcej.
        </Text>
      </Grid.Col>
      <Grid.Col span={4}>
        <Text>
        Dla właścicieli, którzy marzą o psie, który zachowuje się jak wzorowy obywatel - zarówno w domu, jak i na świeżym powietrzu.
        </Text>
      </Grid.Col>
      <Grid.Col span={4}>
        <Text>
        Dla tych, którzy chcą zbudować z psem relację pełną zaufania, harmonii i... sztuczek, które zachwycą wszystkich! 
        </Text>
      </Grid.Col>
    </Grid>
    </>
