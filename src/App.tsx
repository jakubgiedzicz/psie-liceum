  ...
  return (
    <MantineProvider>
      ...
      >
        ...
        <Group mih={250} mt={64} bg={"silver"} justify="space-around">
          <Stack w={'50%'}>
            <Title order={1}>Masz pytania? Porozmawiajmy.</Title>
            <Text>
            ...
            <Group>
              ...
              <Stack>
                ...
                <Text ta={'left'}>E-mail: weronika@gmail.com</Text>
                </Group>
                <Group gap={4}>
                  <Box>
                  ...
                  <Text ta={'left'}>Tel: +48 123 465 789</Text>
                </Group>
              </Stack>
            </Group>
          </Stack>
